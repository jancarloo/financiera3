<?php 
$page = ($data["pagina"]!="")?$data["pagina"]:"trayectoria";
?>
		...
		<div class="row">
			<div class="col-md-12">
				<div class="page-title-heading">
					...
					<?php $this->pnt('titulo','Trayectoria fiscalista'); ?></h1>
				</div><!-- /.page-title-heading -->
				<ul class="breadcrumbs">
					<li><a href="<?php $this->url_inicio(); ?>" title="">Inicio<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
					<li><a href="<?php $this->url_inicio(); ?>fundacion" title="">Fundación<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
					<li><a href="<?php $this->url_inicio(); ?>fundacion/trayectoria" title="">Trayectoria<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>

					<li><a href="<?php $this->pnt('breadcrum_href',$this->url_inicio(['return'=>true]).'fundacion/'.$page); ?>" title="" class="jmy_web_div" data-page="<?php echo $page; ?>" id="breadcrum" data-editor="no">
						<?php $this->pnt('breadcrum','Nombre de la página '); ?>
						></a></li>
				</ul><!-- /.breadcrumbs -->
				...
				<div class="sidebar left">
					...
					<aside class="widget widget-brochure services">
						<div class="brochure-box-title">
							...
							<p class="jmy_web_div" data-page="<?php echo $page; ?>" id="noticia_texto" data-editor="no"><?php $this->pnt('noticia_texto','Texto texto texto texto texto texto texto texto texto
				...
				<div class="content-inner">
				 <div class="row">
	                    ...
	                    <div class="col-md-9"> 
	                          ...
	                          <div class=" jmy_web_slider" data-page="<?php echo $page; ?>"  id="marco<?php echo $i; ?>" data-marco="marco<?php echo $i; ?>" 
	                            <?php
	                            	$va=[];
...
?>" data-titulo="Inica el número de fotos a mostrar"></div>
                ...
                for($u=0;$u<$subsecciones;$u++){  ?>
						...
						<div class="flat-text-block-timeline">
							<div class="year jmy_web_div" data-page="<?php echo $page; ?>" id="subsecciones_titulo_intro_<?php echo $i.'_'.$u; ?>" data-editor="no"><?php $this->pnt('subsecciones_titulo_intro_'.$i.'_'.$u,date('Y')); ?></div>
							<div class="flat-timeline-content">
								<div class="box-content">
									<div class="title jmy_web_div" data-page="<?php echo $page; ?>" id="subsecciones_titulo_<?php echo $i.'_'.$u; ?>" data-editor="no"><?php $this->pnt('subsecciones_titulo_'.$i.'_'.$u,'Título de la subsección'); ?></div>
									<div class=" jmy_web_div" data-page="<?php echo $page; ?>" id="subsecciones_desc_<?php echo $i.'_'.$u; ?>"><?php $this->pnt('subsecciones_desc_'.$i.'_'.$u,'<p>This was the time when we started our company. We had no idea how far we would go, we weren’t even sure that we would be able to survive for a few years. What drove us to start the company was the understanding that we could provide a service no one else was providing.</p> '); ?>
